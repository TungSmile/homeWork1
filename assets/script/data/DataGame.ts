...
import { CodeHexColor, statusCube, statusTouch, styleStore } from './Basic';
...
export class DataGame extends Component {
    ...
    mapSlot = [new Vec3(-400, 250, 0), new Vec3(400, 250, 0), new Vec3(150, 250, 0), new Vec3(-150, 250, 0), new Vec3(-250, -200, 0), new Vec3(0, -200, 0), new Vec3(250, -200, 0)];
    ...
    positionStore = new Vec3(0, -550, 0)
    styleStore = styleStore.Conveyor;
